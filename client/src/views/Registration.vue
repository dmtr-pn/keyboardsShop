    ...
    <div class="container">
        <form class="form" @submit.prevent="registration()">
            ...
            <div class="form__inner">
                <div class="formName">Регистрация</div>
                ...
                <div class="form__item">
                    ...
                    <input type="password" class="form__item-inpt" v-model="this.user.password2" placeholder="Повторите пароль" required>
                </div>

                <button class="btn" type="submit" >Зарегистрироваться</button>
                <div class="m">Есть аккаунт? <router-link to="/login" style="color: #FF7676">Войдите</router-link></div>
            </div>
    ...
    methods: {
        async registration() {
            if(this.user.password === this.user.password2){
                try {
                    let response = await this.authStore.registration(this.user)
